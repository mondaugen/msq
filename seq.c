...
err_t
seq_add_event(seq_t *s, seq_event_t *se)
{
    HeapErr err;
...
void
seq_play_up_to_time(seq_t *seq, size_t time)
{
    seq_event_t *se;
...
static const char *
seq_event_as_str(const seq_event_t *se)
{
    return "default";
}

static void
seq_event_free(seq_event_t *se)
{
    free((void *)se);
}

void
seq_event_init_default(seq_event_t *s, size_t time)
{
    _MZ(s, seq_event_t, 1);
...
static void
seq_end_cb(seq_t *s, seq_event_t *se, size_t time)
{
...
static const char *
seq_end_as_str(const seq_event_t *se)
{
...
seq_end_t *
seq_end_new(size_t event_time, size_t *clock_time)
{
